...
[[OctreeBlock]{.smallcaps}](#OctreeBlock)
...
[[FreeEntity]{.smallcaps}](#FreeEntity)
...
**[Action\*]{.smallcaps}** []{#ActScaleTo .anchor}**[ActScaleTo(Entity\*
entity, float x, float y, float z, float rate)]{.smallcaps}**
...
**[int]{.smallcaps}** []{#AddTriangle .anchor}**[AddTriangle(Surface\*
...
**[void]{.smallcaps}** []{#AppendAction .anchor}**[AppendAction(Action\*
...
**[void]{.smallcaps}** []{#CameraRange .anchor}**[CameraRange(Camera\*
...
**[void]{.smallcaps}** []{#EntityAlpha .anchor}**[EntityAlpha(Entity\*
...
**[void]{.smallcaps}** []{#EntityShininess
...
**[void]{.smallcaps}** []{#FlipMesh .anchor}**[FlipMesh(Mesh\*
mesh)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#FreeAction .anchor}**[FreeAction(Action\*
act)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#Graphics3D .anchor}**[Graphics3D(int
...
**[void]{.smallcaps}** []{#LightConeAngles
...
**[int]{.smallcaps}** []{#LoadAnimSeq .anchor}**[LoadAnimSeq(Entity\*
...
**[Texture\*]{.smallcaps}** []{#LoadTexture
.anchor}**[LoadTexture(char\* file,int flags)]{.smallcaps}**
...
**[Mesh\*]{.smallcaps}** []{#MeshCSG .anchor}**[MeshCSG(Mesh\* m1,
Mesh\* m2, int method = 1)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#MeshCullRadius
.anchor}**[MeshCullRadius(Entity\* ent, float radius)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#MeshDepth .anchor}**[MeshDepth(Mesh\*
mesh)]{.smallcaps}**
...
**[int]{.smallcaps}** []{#MeshesIntersect
.anchor}**[MeshesIntersect(Mesh\* mesh1,Mesh\* mesh2)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#MeshHeight .anchor}**[MeshHeight(Mesh\*
mesh)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#MeshWidth .anchor}**[MeshWidth(Mesh\*
mesh)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ModifyGeosphere
.anchor}**[ModifyGeosphere(Geosphere\* geo, int x, int z, float
new_height)]{.smallcaps}**

Sets the height of a point on a geosphere.

**[void]{.smallcaps}** []{#ModifyTerrain
.anchor}**[ModifyTerrain(Terrain\* terr, int x, int z, float
new_height)]{.smallcaps}**

Sets the height of a point on a terrain.

**[void]{.smallcaps}** []{#MoveEntity .anchor}**[MoveEntity(Entity\*
ent,float x,float y,float z)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#NameEntity .anchor}**[NameEntity(Entity\*
ent,char\* name)]{.smallcaps}**

Sets an entity\'s name.

**[void]{.smallcaps}** []{#OctreeBlock .anchor}**[OctreeBlock(OcTree\*
octree, Mesh\* mesh, int level, float X, float Y, float Z, float
Near=0.0, float Far=1000.0)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#OctreeMesh .anchor}**[OctreeMesh(OcTree\*
octree, Mesh\* mesh, int level, float X, float Y, float Z, float
Near=0.0, float Far=1000.0)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PaintEntity .anchor}**[PaintEntity(Entity\*
ent,Brush\* brush)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PaintMesh .anchor}**[PaintMesh(Mesh\*
mesh,Brush\* brush)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PaintSurface
.anchor}**[PaintSurface(Surface\* surf,Brush\* brush)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ParticleColor
.anchor}**[ParticleColor(Sprite\* sprite, float red, float green, float
blue, float alpha)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ParticleVector
.anchor}**[ParticleVector(Sprite\* sprite, float x, float y, float
z)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ParticleTrail
.anchor}**[ParticleTrail(Sprite\* sprite,int length)]{.smallcaps}**

It sets the length of particle trails (particles are sprites with
[SpriteRenderMode](#SpriteRenderMode) set to 3): those particles can
leave a trail behind them.

**[Entity\*]{.smallcaps}** []{#PickedEntity
.anchor}**[PickedEntity()]{.smallcaps}**
...
**[float]{.smallcaps}** []{#PickedNX
.anchor}**[PickedNX()]{.smallcaps}**
...
**[float]{.smallcaps}** []{#PickedNY
.anchor}**[PickedNY()]{.smallcaps}**

Returns the y component of the normal of the most recently executed Pick
command. This might have been [CameraPick](#CameraPick),
[EntityPick](#EntityPick) or [LinePick](#LinePick).

**[float]{.smallcaps}** []{#PickedNZ
.anchor}**[PickedNZ()]{.smallcaps}**

Returns the z component of the normal of the most recently executed Pick
command. This might have been [CameraPick](#CameraPick),
[EntityPick](#EntityPick) or [LinePick](#LinePick).

**[Surface\*]{.smallcaps}** []{#PickedSurface
.anchor}**[PickedSurface()]{.smallcaps}**
...
**[float]{.smallcaps}** []{#PickedTime
.anchor}**[PickedTime()]{.smallcaps}**

Returns the time taken to calculate the most recently executed Pick
command. This might have been [CameraPick](#CameraPick),
[EntityPick](#EntityPick) or [LinePick](#LinePick).

**[int]{.smallcaps}** []{#PickedTriangle
.anchor}**[PickedTriangle()]{.smallcaps}**
...
**[float]{.smallcaps}** []{#PickedX .anchor}**[PickedX()]{.smallcaps}**
...
**[float]{.smallcaps}** []{#PickedY .anchor}**[PickedY()]{.smallcaps}**
...
**[float]{.smallcaps}** []{#PickedZ .anchor}**[PickedZ()]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PointEntity .anchor}**[PointEntity(Entity\*
ent,Entity\* target_ent,float roll)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PositionEntity
.anchor}**[PositionEntity(Entity\* ent,float x,float y,float z,bool
global)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PositionMesh .anchor}**[PositionMesh(Mesh\*
mesh,float px,float py,float pz)]{.smallcaps}**

Moves all vertices of a mesh

**[void]{.smallcaps}** []{#PositionTexture
.anchor}**[PositionTexture(Texture\* tex,float u_pos,float
v_pos)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PostFXBuffer .anchor}**[PostFXBuffer(PostFX\*
fx, int pass_no, int source_pass, int index, int slot)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PostFXFunction
.anchor}**[PostFXFunction(PostFX\* fx, int pass_no, void
(\*PassFunction)(void))]{.smallcaps}**

Attaches a custom function to a post processing effect *fx*, to be
executed at step *pass_no*, to apply custom post-processing.

**[void]{.smallcaps}** []{#PostFXShader .anchor}**[PostFXShader(PostFX\*
fx, int pass_no, Shader\* shader)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PostFXShaderPass
.anchor}**[PostFXShaderPass(PostFX\* fx, int pass_no, char\* name, int
v)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#PostFXTexture
.anchor}**[PostFXTexture(PostFX\* fx, int pass_no, Texture\* tex, int
slot, int frame=0)]{.smallcaps}**
...
**[Mesh\*]{.smallcaps}** []{#RepeatMesh .anchor}**[RepeatMesh(Mesh\*
mesh,Entity\* parent)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ResetEntity .anchor}**[ResetEntity(Entity\*
ent)]{.smallcaps}**

Resets the collision state of an entity.

**[void]{.smallcaps}** []{#ResetShadow
.anchor}**[ResetShadow(ShadowObject\* shad)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#RotateEntity .anchor}**[RotateEntity(Entity\*
ent,float pitch,float yaw,float roll,bool global)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#RotateMesh .anchor}**[RotateMesh(Mesh\*
mesh,float pitch,float yaw,float roll)]{.smallcaps}**

Rotates all vertices of a mesh by the specified rotation.

**[void]{.smallcaps}** []{#RotateSprite .anchor}**[RotateSprite(Sprite\*
sprite,float ang)]{.smallcaps}**

Rotates a sprite

**[void]{.smallcaps}** []{#RotateTexture
.anchor}**[RotateTexture(Texture\* tex,float ang)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ScaleEntity .anchor}**[ScaleEntity(Entity\*
ent,float x,float y,float z,bool glob)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ScaleMesh .anchor}**[ScaleMesh(Mesh\*
mesh,float sx,float sy,float sz)]{.smallcaps}**

Scales all vertices of a mesh by the specified scaling factors.

**[void]{.smallcaps}** []{#ScaleSprite .anchor}**[ScaleSprite(Sprite\*
sprite,float s_x,float s_y)]{.smallcaps}**

Scales a sprite

**[void]{.smallcaps}** []{#ScaleTexture
.anchor}**[ScaleTexture(Texture\* tex,float u_scale,float
v_scale)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#SetAnimKey .anchor}**[SetAnimKey(Entity\*
ent, float frame, int pos_key=true, int rot_key=true, int
scale_key=true)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#SetAnimTime .anchor}**[SetAnimTime(Entity\*
ent,float time,int seq)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#SetCubeFace .anchor}**[SetCubeFace(Texture\*
tex,int face)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#SetCubeMode .anchor}**[SetCubeMode(Texture\*
tex,int mode)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#SetFloat .anchor}**[SetFloat(Shader\*
material, char\* name, float v1)]{.smallcaps}**

Sets a float parameter to be used inside a shader, where it will be
accessible as *name*.

**[void]{.smallcaps}** []{#SetFloat2 .anchor}**[SetFloat2(Shader\*
material, char\* name, float v1, float v2)]{.smallcaps}**

Sets a float vector with 2 elements to be used inside a shader, where it
will be accessible as *name*.

**[void]{.smallcaps}** []{#SetFloat3 .anchor}**[SetFloat3(Shader\*
material, char\* name, float v1, float v2, float v3)]{.smallcaps}**

Sets a float vector with 3 elements to be used inside a shader, where it
will be accessible as *name*.

**[void]{.smallcaps}** []{#SetFloat4 .anchor}**[SetFloat4(Shader\*
...
**[void]{.smallcaps}** []{#SetInteger .anchor}**[SetInteger(Shader\*
material, char\* name, int v1)]{.smallcaps}**

Sets an integer parameter to be used inside a shader, where it will be
accessible as *name*.

**[void]{.smallcaps}** []{#SetInteger2 .anchor}**[SetInteger2(Shader\*
material, char\* name, int v1, int v2)]{.smallcaps}**

Sets an integer vector with 2 elements to be used inside a shader, where
it will be accessible as *name*.

**[void]{.smallcaps}** []{#SetInteger3 .anchor}**[SetInteger3(Shader\*
material, char\* name, int v1, int v2, int v3)]{.smallcaps}**

Sets an integer vector with 3 elements to be used inside a shader, where
it will be accessible as *name*.

**[void]{.smallcaps}** []{#SetInteger4 .anchor}**[SetInteger4(Shader\*
material, char\* name, int v1, int v2, int v3, int v4)]{.smallcaps}**

Sets an integer vector with 4 elements to be used inside a shader, where
it will be accessible as *name*.

**[void]{.smallcaps}** []{#ShadeEntity .anchor}**[ShadeEntity(Entity\*
ent, Shader\* material)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ShadeMesh .anchor}**[ShadeMesh(Mesh\* mesh,
Shader\* material)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ShadeSurface
.anchor}**[ShadeSurface(Surface\* surf, Shader\*
material)]{.smallcaps}**

Applies a shader to a surface. A shader can be seen as a more advanced
form of brush, that allows to render an object using a custom program

**[void]{.smallcaps}** []{#ShaderFunction
.anchor}**[ShaderFunction(Shader\* material, void
(\*EnableFunction)(void), void (\*DisableFunction)(void))]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ShaderMaterial
.anchor}**[ShaderMaterial(Shader\* material, Material\* tex, char\*
name, int index)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ShaderTexture
.anchor}**[ShaderTexture(Shader\* material, Texture\* tex, char\* name,
int index)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#ShowEntity .anchor}**[ShowEntity(Entity\*
ent)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#SkinMesh .anchor}**[SkinMesh(Mesh\* mesh, int
...
**[void]{.smallcaps}** []{#SpriteRenderMode
.anchor}**[SpriteRenderMode(Sprite\* sprite,int mode)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#SpriteViewMode
.anchor}**[SpriteViewMode(Sprite\* sprite,int mode)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#StencilAlpha
.anchor}**[StencilAlpha(Stencil\* stencil, float a)]{.smallcaps}**

Sets the alpha level of a stencil clear operation: a lower value allows
to preserve the older background

**[void]{.smallcaps}** []{#StencilClsColor
.anchor}**[StencilClsColor(Stencil\* stencil, float r,float g,float
b)]{.smallcaps}**

Sets the color to use to clear the area affected by a stencil, when it
is activated

**[void]{.smallcaps}** []{#StencilClsMode
.anchor}**[StencilClsMode(Stencil\* stencil,int cls_depth,int
cls_zbuffer)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#StencilMesh .anchor}**[StencilMesh(Stencil\*
stencil, Mesh\* mesh, int mode=1)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#StencilMode .anchor}**[StencilMode(Stencil\*
stencil, int mode, int operator=1)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#TerrainHeight .anchor}**[TerrainHeight
(Terrain\* terr, int x, int z)]{.smallcaps}**

Returns the height of the terrain at terrain grid coordinates *x*,*z*.
The value returned is in the range 0 to 1.

**[float]{.smallcaps}** []{#TerrainX .anchor}**[TerrainX (Terrain\*
terr, float x, float y, float z)]{.smallcaps}**

Returns the interpolated x coordinate on a terrain.

**[float]{.smallcaps}** []{#TerrainY .anchor}**[TerrainY (Terrain\*
terr, float x, float y, float z)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#TerrainZ .anchor}**[TerrainZ (Terrain\*
terr, float x, float y, float z)]{.smallcaps}**

Returns the interpolated z coordinate on a terrain.

**[void]{.smallcaps}** []{#TexToBuffer .anchor}**[TexToBuffer(Texture\*
tex,unsigned char\* buffer, int frame)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#TextureBlend
.anchor}**[TextureBlend(Texture\* tex,int blend)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#TextureCoords
.anchor}**[TextureCoords(Texture\* tex,int coords)]{.smallcaps}**
...
**[int]{.smallcaps}** []{#TextureHeight
.anchor}**[TextureHeight(Texture\* tex)]{.smallcaps}**

Returns the height of a texture.

**[void]{.smallcaps}** []{#TextureFilter .anchor}**[TextureFilter(char\*
match_text,int flags)]{.smallcaps}**
...
**[const char\*]{.smallcaps}** []{#TextureName
.anchor}**[TextureName(Texture\* tex)]{.smallcaps}**

Returns a texture\'s filename.

**[int]{.smallcaps}** []{#TextureWidth .anchor}**[TextureWidth(Texture\*
tex)]{.smallcaps}**

Returns the width of a texture.

**[float]{.smallcaps}** []{#TFormedX
.anchor}**[TFormedX()]{.smallcaps}**

Returns the X component of the last [TFormPoint](#TFormPoint),
[TFormVector](#TFormVector) or [TFormNormal](#TFormNormal) operation.

**[float]{.smallcaps}** []{#TFormedY
.anchor}**[TFormedY()]{.smallcaps}**

Returns the Y component of the last [TFormPoint](#TFormPoint),
[TFormVector](#TFormVector) or [TFormNormal](#TFormNormal) operation.

**[float]{.smallcaps}** []{#TFormedZ
.anchor}**[TFormedZ()]{.smallcaps}**

Returns the Z component of the last [TFormPoint](#TFormPoint),
[TFormVector](#TFormVector) or [TFormNormal](#TFormNormal) operation.

**[void]{.smallcaps}** []{#TFormNormal .anchor}**[TFormNormal(float
...
**[void]{.smallcaps}** []{#TFormPoint .anchor}**[TFormPoint(float
x,float y,float z, Entity\* source_entity,Entity\*
dest_entity)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#TFormVector .anchor}**[TFormVector(float
x,float y,float z, Entity\* source_entity,Entity\*
dest_entity)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#TranslateEntity
.anchor}**[TranslateEntity(Entity\* ent,float x,float y,float z,bool
glob)]{.smallcaps}**
...
**[int]{.smallcaps}** []{#TriangleVertex
.anchor}**[TriangleVertex(Surface\* surf,int tri_no,int
corner)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#TurnEntity .anchor}**[TurnEntity(Entity\*
ent,float x,float y,float z,bool glob)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UpdateNormals
.anchor}**[UpdateNormals(Entity\* ent)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UpdateTexCoords
.anchor}**[UpdateTexCoords(Surface\* surf)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UpdateWorld .anchor}**[UpdateWorld(float
anim_speed)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseEntity .anchor}**[UseEntity(Shader\*
material, char\* name, Entity\* ent, int mode)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseFloat .anchor}**[UseFloat(Shader\*
material, char\* name, float\* v1)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseFloat2 .anchor}**[UseFloat2(Shader\*
material, char\* name, float\* v1, float\* v2)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseFloat3 .anchor}**[UseFloat3(Shader\*
...
**[void]{.smallcaps}** []{#UseFloat4 .anchor}**[UseFloat4(Shader\*
material, char\* name, float\* v1, float\* v2, float\* v3, float\*
v4)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseInteger .anchor}**[UseInteger(Shader\*
material, char\* name, int\* v1)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseInteger2 .anchor}**[UseInteger2(Shader\*
material, char\* name, int\* v1, int\* v2)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseInteger3 .anchor}**[UseInteger3(Shader\*
material, char\* name, int\* v1, int\* v2, int\* v3)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseInteger4 .anchor}**[UseInteger4(Shader\*
...
**[void]{.smallcaps}** []{#UseMatrix .anchor}**[UseMatrix(Shader\*
material, char\* name, int mode)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseStencil .anchor}**[UseStencil(Stencil\*
stencil)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#UseSurface .anchor}**[UseSurface(Shader\*
material, char\* name, Surface\* surface, int vbo)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#VectorPitch .anchor}**[VectorPitch(float
vx,float vy,float vz)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#VectorYaw .anchor}**[VectorYaw(float
vx,float vy,float vz)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#VertexAlpha .anchor}**[VertexAlpha(Surface\*
surf,int vid)]{.smallcaps}**

Returns the alpha component of a vertices color, set using
[VertexColor](#VertexColor)

**[float]{.smallcaps}** []{#VertexBlue .anchor}**[VertexBlue(Surface\*
surf,int vid)]{.smallcaps}**

Returns the blue component of a vertices color.

**[void]{.smallcaps}** []{#VertexColor .anchor}**[VertexColor(Surface\*
surf,int vid,float r,float g,float b,float a)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#VertexCoords
.anchor}**[VertexCoords(Surface\* surf,int vid,float x,float y,float
z)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#VertexGreen .anchor}**[VertexGreen(Surface\*
surf,int vid)]{.smallcaps}**

Returns the green component of a vertices color.

**[void]{.smallcaps}** []{#VertexNormal
.anchor}**[VertexNormal(Surface\* surf,int vid,float nx,float ny,float
nz)]{.smallcaps}**

Sets the normal of an existing vertex.

**[float]{.smallcaps}** []{#VertexNX .anchor}**[VertexNX(Surface\*
surf,int vid)]{.smallcaps}**

Returns the x component of a vertices normal.

**[float]{.smallcaps}** []{#VertexNY .anchor}**[VertexNY(Surface\*
surf,int vid)]{.smallcaps}**

Returns the y component of a vertices normal.

**[float]{.smallcaps}** []{#VertexNZ .anchor}**[VertexNZ(Surface\*
surf,int vid)]{.smallcaps}**

Returns the z component of a vertices normal.

**[float]{.smallcaps}** []{#VertexRed .anchor}**[VertexRed(Surface\*
surf,int vid)]{.smallcaps}**

Returns the red component of a vertices color.

**[void]{.smallcaps}** []{#VertexTexCoords
.anchor}**[VertexTexCoords(Surface\* surf,int vid,float u,float v,float
w,int coord_set)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#VertexU .anchor}**[VertexU(Surface\*
surf,int vid,int coord_set)]{.smallcaps}**

Returns the texture u coordinate of a vertex.

**[float]{.smallcaps}** []{#VertexV .anchor}**[VertexV(Surface\*
surf,int vid,int coord_set)]{.smallcaps}**

Returns the texture v coordinate of a vertex.

**[float]{.smallcaps}** []{#VertexW .anchor}**[VertexW(Surface\*
surf,int vid,int coord_set)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#VertexX .anchor}**[VertexX(Surface\*
surf,int vid)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#VertexY .anchor}**[VertexY(Surface\*
surf,int vid)]{.smallcaps}**
...
**[float]{.smallcaps}** []{#VertexZ .anchor}**[VertexZ(Surface\*
surf,int vid)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#VoxelSpriteMaterial
.anchor}**[VoxelSpriteMaterial(VoxelSprite\* voxelspr, Material\*
mat)]{.smallcaps}**
...
**[void]{.smallcaps}** []{#Wireframe .anchor}**[Wireframe(int
enable)]{.smallcaps}**
