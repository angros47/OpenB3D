...
"    vNormal = vec3(vec4(reflect( pos_eye, norm_eye),0.0)*uVMatrix)*vec3(1.0,-1.0,-1.0);"
"    vColor = aVertexColor;\r\n"
...
"  uniform int tex_coord_set[Textures];\r\n"
...
"      texColor[0] = texture2D(uSampler0, (texMat[0]*vec3((tex_coord_set[0]==0?vTextureCoord:(tex_coord_set[0]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #if (Textures>1)\r\n"
"      texColor[1] = texture2D(uSampler1, (texMat[1]*vec3((tex_coord_set[1]==0?vTextureCoord:(tex_coord_set[1]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #endif\r\n"
"    #if (Textures>2)\r\n"
"      texColor[2] = texture2D(uSampler2, (texMat[2]*vec3((tex_coord_set[2]==0?vTextureCoord:(tex_coord_set[2]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #endif\r\n"
"    #if (Textures>3)\r\n"
"      texColor[3] = texture2D(uSampler3, (texMat[3]*vec3((tex_coord_set[3]==0?vTextureCoord:(tex_coord_set[3]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #endif\r\n"
"    #if (Textures>4)\r\n"
"      texColor[4] = texture2D(uSampler4, (texMat[4]*vec3((tex_coord_set[4]==0?vTextureCoord:(tex_coord_set[4]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #endif\r\n"
"    #if (Textures>5)\r\n"
"      texColor[5] = texture2D(uSampler5, (texMat[5]*vec3((tex_coord_set[5]==0?vTextureCoord:(tex_coord_set[5]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #endif\r\n"
"    #if (Textures>6)\r\n"
"      texColor[6] = texture2D(uSampler6, (texMat[6]*vec3((tex_coord_set[6]==0?vTextureCoord:(tex_coord_set[6]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #endif\r\n"
"    #if (Textures>7)\r\n"
"      texColor[7] = texture2D(uSampler7, (texMat[7]*vec3((tex_coord_set[7]==0?vTextureCoord:(tex_coord_set[7]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #endif\r\n"
"    #if (Textures>8)\r\n"
"      texColor[8] = texture2D(uSampler8, (texMat[8]*vec3((tex_coord_set[8]==0?vTextureCoord:(tex_coord_set[8]==1?vTextureCoord2:vNormal.xy*0.5+vec2(0.5,0.5) )),1.0)).xy);\r\n"
"    #endif\r\n"
